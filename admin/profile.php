                            ...
                            <div class="card-body">
                                <div class="input-states">
                                    <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" ><a href="../constant/logout.php"><i class="fa fa-sign-out"></i> Logout</a></button>
...
<div class="popup popup--icon -success js_success-popup popup--visible">
  ...
  <div class="popup__content">
    ...
    <p>
      <button class="button button--success" data-for="js_success-popup">Cl0se</button>
    </p>
  </div>
</div>
